...
INVOICES.ACCOUNT,
INVOICES.TYPE
INTO :ZYUV_IVNUM,:ZYUV_CUST,:ZYUV_ACCOUNT,:ZYUV_TYPE
FROM INVOICES
WHERE IV = :ZYUV_IV ;
/******/
GOTO 9988 WHERE :ZYUV_TYPE <> 'C' ;
:ZYUV_CUSTACCOUNT = 0 ;
SELECT
CUSTOMERS.CUST
...
/*****/
EXECUTE WINHTML '-d', 'ZTAN_EWWWSHOWCIV', '', '', '-v', :ZYUV_IV,
'-s',
'-edoc', '-pdf', :ZYUV_FILENAME,'-format',-12;
/*
XECUTE WINHTML '-d', 'ZTAN_EWWWSHOWCIV', '', '', '-v', :ZYUV_IV, '-
s',
